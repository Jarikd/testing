...
$(function() {
    ...
    function i(t) {
        ...
        return u = n(100, 600), f = '<li class="review__item"><div class="review__user_photo"><img src="https://twowords.info/img/users/' + i + '.jpg" alt=""></div><div class="review__info"><div class="review__info_name">' + names[i] + '</div><div class="review__info_signature">только что заработал(а)</div><div class="review__info_money">$ ' + u + "," + n(10, 99) + '</div></div></li>', [f, i]
    }
